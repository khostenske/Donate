...
Books For Africa remains the largest shipper of donated text and library books to the African continent, shipping over 32 million books to 49 different countries since 1988.  Over the past 12 months we have shipped 2.6 million books, valued at $35 million to 27 African countries, with an additional 223 computers and 11 brand new law and human rights libraries.</p>
			</br></br><h2>Project Funding</h2>
				<h3>Books For Africa receives financial support from a wide variety of partners as well as private donators.</h3>
			<input type="submit" value="Donate">
			</div></div></div>
	</td>
<td>

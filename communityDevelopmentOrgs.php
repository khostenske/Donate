...
<body>
	...
	<div class='row content'> 
		<div class='columns large-3 project'>
			...
			<div class='body'>
					<h2>Florida</h2>
					<p>HandsOn Miami partners with non-profit organizations throughout Miami-Dade County to offer volunteers hundreds of worthwhile and gratifying service opportunities each month.<a href='#' class='read-more-link'>...Read more</a><span class='read-more-content'>HandsOn Miami offers a Flexible Volunteering Model. We hope to make volunteering more convenient for you. There is no long-term commitment, no background checks or detailed training, and we encourage volunteers to try and experience a variety of different projects. All projects are offered on our online calendar, to help you find something during a day and time that works for you, and are led by HandsOn Miami Project Leaders.</span><a href='#' class='read-less-link'>...Read Less</a></p>
...
<td>	
	...
	<div class='row content'> 
		<div class='columns large-3 project'>
			...
			<h2>Project Funding</h2>
				<h3>ASAS has various philanthropic partners that help support the organization in order to help as many youth across the United States. </h3>
			<input type="submit" value="Donate">
			</div></div></div>
	</td>
<td>

	...
	<div class='row content'> 
		<div class='columns large-3 project'>
			...
			<div class='body'>
					...
					<p>The American Red Cross exists to provide compassionate care to those in need. Our network of generous donors, volunteers and employees share a mission
					of preventing and relieving suffering, here at home and around the world, through five key service areas: Disaster Relief, Supporting America's Military Families, Lifesaving Blood, Health and Safety Services, and International Services</p>
			</br></br></br></br><h2>Project Funding</h2>
				<h3>Red Cross has many different partners and ordinary people who donate many different ways to support their efforts</h3>
			<input type="submit" value="Donate">
			</div></div></div>
	</td>
<td>
	<div class='row content'> 
		<div class='columns large-3 project'>
			...
			<div class='body'>
					<h2>United States</h2>
					<p>We operate as an independent agent of change, seeking and promoting more effective, easily-delivered and less-expensive methods
					to prevent illness and death of children, such as oral rehydration therapy to prevent dehydration and immunizations.
